...
//			if (contact->IsMemberOfHardwiredGroup(CGroup::ALL_BUDDIES, result) && !result)
...
//	bool result;
//
//	contact->IsMemberOfHardwiredGroup(CGroup::ALL_BUDDIES, result);
//	if (result)
//	{
...
//	}
//
//	contact->IsMemberOfHardwiredGroup(CGroup::CONTACTS_WAITING_MY_AUTHORIZATION, result);
//	if (result)
//	{
//		SEString data;
//
...
//			contact.fetch();
//			bool result;
//			if (contact->IsMemberOfHardwiredGroup(CGroup::ALL_BUDDIES, result))
//			{
//				CGroup::Ref group;
//				if (this->skype->GetHardwiredContactGroup(CGroup::ALL_BUDDIES, group))
//				{
//					group.fetch();
...
//{
//	//this->skype->GetHardwiredContactGroup(CGroup::ALL_BUDDIES, this->commonList);
...
//	//this->skype->GetHardwiredContactGroup(CGroup::CONTACTS_WAITING_MY_AUTHORIZATION, this->authWaitList);
