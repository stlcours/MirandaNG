...
//
//INT_PTR CSkypeProto::OnModulesLoaded(WPARAM, LPARAM)
//{
//	this->InitSkype();
//
//	//this->InitChat();
...
//}
//
//INT_PTR CSkypeProto::OnPreShutdown(WPARAM, LPARAM)
//{
...
//}
//
//INT_PTR CSkypeProto::OnContactDeleted(WPARAM wParam, LPARAM lParam)
//{
...
//{
//	/*CTransfer::STATUS status;
//	transfer->GetPropStatus(status);
//	if ((status == CTransfer::CANCELLED) || (status == CTransfer::COMPLETED) || 
//		(status == CTransfer::FAILED) || (status == CTransfer::CANCELLED_BY_REMOTE))
//	{
//		if (this->account->TransferList.contains(transfer))
//		{
//			this->account->TransferList.remove_val(transfer);
//		}
//	}*/
//}
//
...
//	//		{
//	//			/*transferList[i]->SetOnTransferChangedCallback(
//	//				(CTransfer::OnTransferChanged)&CSkypeProto::OnTransferChanged, this);*/
//	//			this->account->TransferList.append(transferList[i]);
//	//		}
//	//		
//	//		SEString bodyXml;
