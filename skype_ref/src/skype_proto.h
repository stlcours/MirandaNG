...
//#include "wrapper\group.h"
#include "wrapper\skype.h"
//#include "wrapper\search.h"
//#include "wrapper\account.h"
//#include "wrapper\contact.h"
//#include "wrapper\message.h"
//#include "wrapper\transfer.h"
//#include "wrapper\participant.h"
//#include "wrapper\conversation.h"
...
//
//	CSkypeTransfer(CSkypeProto* ppro) : ppro(ppro) { }
//	~CSkypeTransfer(void) { }
//};
...
//	CGroup::Ref commonList;
//	CGroup::Ref authWaitList;
//
//	// account
...
//
//	//
//	INT_PTR __cdecl OnModulesLoaded(WPARAM, LPARAM);
//	INT_PTR __cdecl OnPreShutdown(WPARAM, LPARAM);
//	INT_PTR __cdecl OnContactDeleted(WPARAM, LPARAM);
//	INT_PTR __cdecl OnOptionsInit(WPARAM, LPARAM);
//	INT_PTR __cdecl OnUserInfoInit(WPARAM, LPARAM);
