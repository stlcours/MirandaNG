			...
			case IDC_REGISTER:
				{
					...
					CSkypeKit::VALIDATERESULT reason;
					proto->skypeKit->ValidatePassword(sid, pwd, reason);

					if (reason == CSkypeKit::VALIDATED_OK)
					{
						CAccount::Ref account;
						proto->skypeKit->GetAccount(sid, proto->account);
